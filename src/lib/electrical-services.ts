...
Object.assign(ELECTRICAL_SERVICES, {
  ...
  "emergency-electrician-consultation": specificElectricalService({
    ...
    description:
      "Emergency electrician consultation in Bangalore for urgent power, tripping, socket, wiring and electrical safety concerns.",
    hero: "Emergency Electrician Consultation in Bangalore",
    intro: [
      "Electrical warning signs need a calm, safety-first response. If there are sparks, smoke, a burning smell or exposed live wiring, keep clear and switch off power only when it is safe.",
      "Numunix helps you arrange the appropriate electrician visit for urgent power and wiring concerns. Describe what happened, which area is affected and whether the circuit can be safely isolated.",
    ],
    included: [
      "Urgent electrical symptom assessment",
      "Advice on safe isolation before the visit",
      "Power, socket and wiring fault review",
      "Clear next-step recommendation",
    ],
    signs: [
      "Burning smell, sparks or a hot socket",
      "A circuit trips repeatedly",
      "Sudden loss of power in part of the property",
      "Visible damaged or exposed wiring",
    ],
    faqs: [
      {
        question: "What should I do before an emergency electrician arrives?",
        answer:
          "Keep people away from the affected point and switch off the relevant supply only if it is safe. Do not touch exposed wiring or continue using a hot or sparking socket.",
      },
      {
        question: "Is repeated MCB tripping an emergency?",
        answer:
          "It can indicate an electrical fault. Avoid repeatedly resetting it and arrange an inspection, especially if there is heat, smell or visible damage.",
      },
    ],
  }),
  "wiring-circuit-repairs": specificElectricalService({
    slug: "wiring-circuit-repairs",
    name: "Wiring & Circuit Repairs Consultation",
    shortName: "wiring and circuit repair",
    seoTitle: "Wiring & Circuit Repair in Bangalore | Numunix",
    description:
      "Wiring and circuit repair consultation in Bangalore for power loss, faulty points, loose connections and recurring electrical faults.",
    hero: "Wiring & Circuit Repairs in Bangalore",
    intro: [
      "Faulty wiring can make a room unreliable and unsafe. A circuit that loses power, flickers or works intermittently needs diagnosis at the relevant point rather than a temporary workaround.",
      "Our electrician assesses the reported symptoms, accessible connections and circuit behaviour before explaining the appropriate repair.",
    ],
    included: [
      "Circuit and point fault assessment",
      "Loose connection and wiring repair planning",
      "Power-loss and intermittent-fault checks",
      "Safety guidance for damaged wiring",
    ],
    signs: [
      "Lights or sockets work intermittently",
      "One room or circuit has no power",
      "Flickering or buzzing at a point",
      "A repair keeps failing or returning",
    ],
    faqs: [
      {
        question: "Can wiring be repaired without rewiring the entire home?",
        answer:
          "Often the affected point or circuit can be assessed and repaired directly. The electrician will explain if a wider upgrade is needed.",
      },
      {
        question: "Should I use a faulty socket until it is repaired?",
        answer:
          "No. Stop using a socket that is loose, hot, sparking or intermittent until it has been inspected.",
      },
    ],
  }),
  "mcb-fuse-box-service": specificElectricalService({
    slug: "mcb-fuse-box-service",
    name: "MCB & Fuse Box Repair/Installation Consultation",
    shortName: "MCB and fuse box service",
    seoTitle: "MCB & Fuse Box Repair in Bangalore | Numunix",
    description:
      "MCB and fuse box repair or installation consultation in Bangalore for tripping breakers, damaged boards and circuit protection concerns.",
    hero: "MCB & Fuse Box Service in Bangalore",
    intro: [
      "An MCB is designed to interrupt power when it detects an unsafe condition. Repeated trips should be investigated instead of reset again and again.",
      "Numunix arranges MCB and fuse-box checks for homes, offices and shops, including repair, replacement and installation planning.",
    ],
    included: [
      "Repeated MCB trip assessment",
      "Fuse box and distribution-board checks",
      "MCB replacement or installation planning",
      "Load and circuit protection guidance",
    ],
    signs: [
      "An MCB will not stay on",
      "A fuse box looks damaged or overheated",
      "A circuit trips when an appliance runs",
      "You need a new or upgraded distribution board",
    ],
    faqs: [
      {
        question: "Why will my MCB not stay on?",
        answer:
          "A short circuit, overload, earth leakage or appliance fault may be involved. It needs testing before the breaker is reset.",
      },
      {
        question: "Can I replace an MCB myself?",
        answer:
          "Electrical protection devices should be selected and installed by a qualified electrician after the circuit has been assessed.",
      },
    ],
  }),
  "inverter-installation": specificElectricalService({
    ...
    seoTitle: "Inverter Installation in Bangalore | Numunix",
    description:
      "Inverter installation in Bangalore with setup, connection, load and backup-power guidance for homes and offices.",
    hero: "Inverter Installation in Bangalore",
    intro: [
      "A well-planned inverter installation considers the intended backup load, battery arrangement, ventilation and safe electrical connection.",
      "Share your inverter and battery details, the appliances you want to support and the available installation space so the visit can be planned properly.",
    ],
    included: [
      "Inverter and battery setup assessment",
      "Safe connection and placement review",
      "Backup-load planning",
      "Basic operation and testing guidance",
    ],
    signs: [
      "You are installing a new inverter",
      "You need backup for selected appliances",
      "An existing setup is being relocated",
      "You are unsure about battery or load requirements",
    ],
    faqs: [
      {
        question: "Can an inverter run every appliance at home?",
        answer:
          "That depends on its rating, battery setup and appliance load. The intended backup circuits should be discussed before installation.",
      },
      {
        question: "Where should an inverter be installed?",
        answer:
          "It needs a suitable, ventilated location with safe access and an appropriate electrical connection.",
      },
    ],
  }),
  "inverter-uninstallation": specificElectricalService({
    ...
    shortName: "inverter uninstallation",
    seoTitle: "Inverter Uninstallation in Bangalore | Numunix",
    description:
      "Inverter uninstallation in Bangalore for safe removal, relocation and disconnection of inverter and UPS systems.",
    hero: "Inverter Uninstallation in Bangalore",
    intro: [
      "Removing an inverter means disconnecting backup power, batteries and connected circuits safely. It is particularly important not to leave loose conductors or an incomplete backup circuit behind.",
      "Numunix helps arrange an electrician visit for planned inverter or UPS removal and relocation.",
    ],
    included: [
      "Safe inverter and battery disconnection",
      "Relocation and removal planning",
      "Connected-point review",
      "Advice on storage or reinstallation",
    ],
    signs: [
      "You are moving home or office",
      "An old inverter is no longer needed",
      "The unit must be relocated",
      "You are replacing the backup system",
    ],
    faqs: [
      {
        question: "Can I disconnect an inverter myself?",
        answer:
          "Because the system involves batteries and mains connections, professional disconnection is the safer option.",
      },
      {
        question: "Can a removed inverter be installed elsewhere?",
        answer:
          "Usually, subject to its condition and the electrical requirements at the new location.",
      },
    ],
  }),
  "inverter-check-up": specificElectricalService({
    slug: "inverter-check-up",
    name: "Inverter Check Up",
    shortName: "inverter check-up",
    seoTitle: "Inverter Check Up in Bangalore | Numunix",
    description:
      "Inverter check-up in Bangalore for poor backup, charging issues, alarms, battery concerns and unreliable UPS performance.",
    hero: "Inverter Check Up in Bangalore",
    intro: [
      "Poor backup time, alarm sounds or charging concerns can come from battery condition, load, cabling or the inverter itself. A check-up helps identify the most likely cause.",
      "Let us know the model, battery age and what happens during a power cut to give the electrician a useful starting point.",
    ],
    included: [
      "Charging and backup symptom review",
      "Basic battery and connection checks",
      "Load and alarm assessment",
      "Maintenance and repair recommendation",
    ],
    signs: [
      "Backup time has reduced",
      "The inverter is not charging",
      "The UPS alarms or shuts down",
      "You have not serviced the system recently",
    ],
    faqs: [
      {
        question: "Why has my inverter backup time dropped?",
        answer:
          "Battery health, load, charging performance and age all affect backup time. A check-up can identify the relevant factor.",
      },
      {
        question: "How often should an inverter be checked?",
        answer:
          "The suitable interval depends on use and battery type; arrange a check when backup changes or warning signs appear.",
      },
    ],
  }),
  "water-motor-installation-repair": specificElectricalService({
    slug: "water-motor-installation-repair",
    name: "Water Motor Installation & Repair Consultation",
    shortName: "water motor installation or repair",
    seoTitle: "Water Motor Installation & Repair in Bangalore | Numunix",
    description:
      "Water motor installation and repair consultation in Bangalore for pumps that do not start, trip power, lose pressure or need safe connection work.",
    hero: "Water Motor Installation & Repair in Bangalore",
    intro: [
      "A motor that will not start, trips the power or runs without pressure needs a careful check of the pump setup and electrical connection.",
      "Tell us whether the concern is installation, no water, a power trip or unusual noise, and avoid touching connections in a wet area.",
    ],
    included: [
      "Pump connection and power symptom assessment",
      "Water motor installation planning",
      "Starter and control-point review",
      "Safe next-step guidance",
    ],
    signs: [
      "The pump will not start",
      "The MCB trips when it runs",
      "Water pressure has dropped",
      "The motor is noisy or runs continuously",
    ],
    faqs: [
      {
        question: "Why does a water motor trip the MCB?",
        answer:
          "The motor, control equipment, wiring or moisture may be involved. It should be inspected rather than repeatedly reset.",
      },
      {
        question: "Do you help install new water motors?",
        answer:
          "Yes. The electrician can assess the electrical requirements and proposed setup before installation.",
      },
    ],
  }),
  "socket-switchboard-service": specificElectricalService({
    slug: "socket-switchboard-service",
    name: "Socket & Switchboard Repair/Installation Consultation",
    shortName: "socket and switchboard service",
    seoTitle: "Socket & Switchboard Repair in Bangalore | Numunix",
    description:
      "Socket and switchboard repair or installation consultation in Bangalore for loose, damaged, non-working or upgraded electrical points.",
    hero: "Socket & Switchboard Service in Bangalore",
    intro: [
      "A loose, warm or unreliable socket should not be ignored. The fitting, connection and circuit need to be assessed before repair or replacement.",
      "We arrange support for individual sockets, switches and switchboards, whether you are fixing a fault or updating a room.",
    ],
    included: [
      "Socket and switch fault assessment",
      "Switchboard repair or replacement planning",
      "New point installation assessment",
      "Safe-use guidance",
    ],
    signs: [
      "A socket is loose, warm or not working",
      "A switch sparks or works intermittently",
      "You need additional electrical points",
      "An old switchboard needs replacement",
    ],
    faqs: [
      {
        question: "Is a loose socket dangerous?",
        answer:
          "It can be. Stop using it and arrange an inspection, especially if it is hot, discoloured or sparking.",
      },
      {
        question: "Can a new socket be installed in any location?",
        answer:
          "The electrician will check the available wiring, circuit capacity and the location before advising.",
      },
    ],
  }),
  "fan-installation-repair": specificElectricalService({
    slug: "fan-installation-repair",
    name: "Fan Installation & Repair Consultation",
    shortName: "fan installation or repair",
    seoTitle: "Fan Installation & Repair in Bangalore | Numunix",
    description:
      "Fan installation and repair consultation in Bangalore for ceiling fans, exhaust fans, regulators, noise, wobble and non-working units.",
    hero: "Fan Installation & Repair in Bangalore",
    intro: [
      "A ceiling fan should be securely mounted, correctly connected and stable in use. Noise, wobble, slow speed or a fan that will not start can point to a fitting, regulator or electrical issue.",
      "Numunix helps arrange the right electrician visit for fan installation, replacement and fault checks.",
    ],
    included: [
      "Ceiling and exhaust fan installation",
      "Fan, regulator and point checks",
      "Wobble and noise assessment",
      "Replacement and mounting guidance",
    ],
    signs: [
      "A fan will not start or runs slowly",
      "The fan wobbles or makes unusual noise",
      "You are replacing a ceiling fan",
      "A regulator is not working properly",
    ],
    faqs: [
      {
        question: "Can you replace an old ceiling fan?",
        answer:
          "Yes. The electrician checks the existing mounting and connection before replacement.",
      },
      {
        question: "Why is my fan wobbling?",
        answer:
          "Blade balance, mounting, fasteners or the fan assembly may be responsible and should be checked safely.",
      },
    ],
  }),
  "light-installation-repair": specificElectricalService({
    slug: "light-installation-repair",
    name: "Light Installation & Repair Consultation",
    shortName: "light installation or repair",
    seoTitle: "Light Installation & Repair in Bangalore | Numunix",
    description:
      "Light installation and repair consultation in Bangalore for ceiling lights, fixtures, LED fittings, dimming, flickering and non-working points.",
    hero: "Light Installation & Repair in Bangalore",
    intro: [
      "A new light fitting needs the right mounting and connection, while flickering or failed lights can have causes beyond the bulb itself.",
      "Describe the fixture, location and symptom so the electrician can assess whether the issue is the light, switch, driver or electrical point.",
    ],
    included: [
      "Light fitting and fixture installation",
      "Flickering and non-working light checks",
      "LED driver and point assessment",
      "Mounting and replacement guidance",
    ],
    signs: [
      "A light flickers or will not turn on",
      "You are installing a new fixture",
      "A dimmer or switch is unreliable",
      "A ceiling light needs replacement",
    ],
    faqs: [
      {
        question: "Why does an LED light flicker?",
        answer:
          "The lamp, driver, dimmer, switch or connection may be involved. An inspection can identify the cause.",
      },
      {
        question: "Can heavy light fixtures be installed?",
        answer:
          "The mounting point and fixture requirements should be checked first so the installation is secure.",
      },
    ],
  }),
  "appliance-wiring-installation": specificElectricalService({
    slug: "appliance-wiring-installation",
    name: "Appliance Wiring & Installation Consultation",
    shortName: "appliance wiring and installation",
    seoTitle: "Appliance Wiring & Installation in Bangalore | Numunix",
    description:
      "Appliance wiring and installation consultation in Bangalore for suitable power points, safe connections and electrical load assessment.",
    hero: "Appliance Wiring & Installation in Bangalore",
    intro: [
      "Large and fixed appliances need a suitable electrical point, safe connection and sufficient circuit capacity. Connecting them casually can lead to tripping, heat or damage.",
      "Numunix helps arrange assessment and installation support for appliance wiring at homes, offices and shops.",
    ],
    included: [
      "Appliance point and load assessment",
      "Dedicated circuit and connection planning",
      "Safe wiring installation support",
      "Testing and operating guidance",
    ],
    signs: [
      "A new appliance needs a power point",
      "An appliance trips the circuit",
      "You are renovating a kitchen or office",
      "The existing socket does not suit the appliance",
    ],
    faqs: [
      {
        question: "Does every appliance need a dedicated socket?",
        answer:
          "It depends on the appliance load and existing circuit. The electrician can advise on the appropriate setup.",
      },
      {
        question: "Can an appliance be connected to an extension board?",
        answer:
          "High-load or fixed appliances often need a proper rated point rather than an extension board. Have the setup assessed first.",
      },
    ],
  }),
});
