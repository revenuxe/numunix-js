    ...
    <main className="grid min-h-screen place-items-center bg-secondary/40 px-4 py-10 text-ink">
      ...
      >
        ...
        <label className="mt-7 block">
          ...
          <input
            value="admin@numunix.com"
            readOnly
            className="mt-1.5 w-full rounded-xl bg-white/10 px-4 py-3 text-sm text-white ring-1 ring-white/20 outline-none"
          />
        </label>
