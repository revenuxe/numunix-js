...
type Lead = { id: string; created_at: string; name: string; email: string | null; phone: string | null; postal_code: string | null; service: string; message: string | null; source: string; booking_id: string | null };
