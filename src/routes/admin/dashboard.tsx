...
type Lead = { id: string; created_at: string; name: string; email: string; phone: string | null; postal_code: string | null; service: string; message: string | null; source: string };
