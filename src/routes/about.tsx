...
export const Route = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [
      { title: "About Numunix — Trusted IT Support Since 2020" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "About Numunix" },
      ...
      <section className="mx-auto max-w-6xl px-4 py-20 md:px-8 md:py-28">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div className="overflow-hidden rounded-[2rem] ring-1 ring-border shadow-card">
            <img src={teamImg} alt="Numunix team" className="h-full w-full object-cover" />
          </div>
          <div>
            ...
            <div className="mt-6 space-y-4 text-muted-foreground">
              <p>
                Numunix began in {CONTACT.founded} as a small hands-on repair
                bench built around a simple idea — treat every laptop, every
                desktop and every business like it belongs to a friend. No
                jargon, no inflated quotes, just honest engineering.
              </p>
              <p>
                Word travelled. What started with laptop tune-ups and screen
                replacements grew into CCTV installations, structured
                networking and Annual Maintenance Contracts for growing
                offices across the city.
              </p>
              <p>
                In {CONTACT.onlineSince}, we took Numunix online so anyone
                can book a certified engineer in minutes — whether it's a
                sluggish home laptop or a full office rollout. The bench is
                bigger now, but the values haven't changed.
              </p>
            </div>
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full bg-[#25D366] px-5 py-3 text-sm font-semibold text-white hover:brightness-110"
              >
        ...
        <div className="relative mx-auto max-w-6xl overflow-hidden rounded-[2rem] bg-ink px-6 py-14 text-white md:px-14 md:py-20">
          ...
          <div className="relative max-w-2xl">
            ...
            <p className="mt-4 text-white/80">
              Book a certified Numunix engineer or send us a quick WhatsApp
              message — we usually reply within minutes.
            </p>
