  ...
  return (
    <section id="book" className="bg-white px-4 pb-16 md:px-8">
      <div className="relative mx-auto max-w-6xl overflow-hidden rounded-[2rem]">
        <img src={findBanner} alt="Numunix data center" width={1600} height={900} loading="lazy" className="h-[420px] w-full object-cover sm:h-[460px] md:h-[500px]" />
        ...
        <div className="absolute inset-0 flex items-center px-6 md:px-12 lg:px-16">
          <div className="w-full max-w-lg rounded-3xl bg-white/10 p-7 text-white ring-1 ring-white/25 shadow-card backdrop-blur-xl md:p-10">
            ...
            {showEngineer && <div className="mt-4 rounded-2xl bg-white/15 p-4 ring-1 ring-white/25"><p className="text-sm font-semibold">Support is available for your area.</p><p className="mt-1 text-xs text-white/75">Call our engineer for quick assistance.</p><a href={CONTACT.telUrl} className="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-full bg-brand px-4 py-3 text-sm font-semibold text-brand-foreground transition hover:brightness-110"><Phone className="h-4 w-4" />Call Our Engineer: {CONTACT.phoneDisplay}</a></div>}
          </div>
        </div>
      </div>
    </section>
