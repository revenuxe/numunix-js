...
export const Route = createFileRoute("/why-us")({
  ...
  head: () => ({
    meta: [
      { title: "Why Numunix — Certified IT Engineers You Can Trust" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Why Numunix" },
      ...
      <section className="bg-secondary/40 px-4 py-20 md:px-8 md:py-28">
        ...
        <div className="mx-auto mt-14 grid max-w-6xl gap-5 md:grid-cols-2 lg:grid-cols-5">
          {PROCESS.map((p) => (
            <div
              key={p.step}
              className="rounded-3xl bg-white p-6 ring-1 ring-border shadow-soft"
            >
